          ...
          <div className="user-profile-edit">
            ...
            <form>
              ...
              <div className="section">
                ...
                <input defaultValue={user.name} onChange={(event) => { setUserName(event.target.value); }} type="text" id="name" />
              </div>
              ...
              <div className="section">
                ...
                <div style={{ display: "flex", }} className="gender" >
                  <div>
                    <input checked={gender === "female"} type="radio" value="female" name="gender" onChange={(event) => { setGender(event.target.value); }} />
                    <label htmlFor="female">Female</label>
                  </div>
                  <div>
                    <input checked={gender === "male"} type="radio" value="male" name="gender" onChange={(event) => { setGender(event.target.value); }} />
                    <label htmlFor="male">Male</label>
                  </div>
                  <div> <input checked={gender === "other"} type="radio" value="other" name="gender" onChange={(event) => { setGender(event.target.value); }} />
